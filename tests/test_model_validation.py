...
from marketmind_ai.llm_clients.base_client import BaseLLMClient
from marketmind_ai.llm_clients.model_catalog import get_known_models
from marketmind_ai.llm_clients.validators import validate_model
...
class ModelValidationTests(unittest.TestCase):
    def test_catalog_models_are_all_validator_approved(self):
        for provider, models in get_known_models().items():
            if provider in ("ollama", "openrouter", "azure"):
                continue
            for model in models:
